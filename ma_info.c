...
MADB_TypeInfo TypeInfoV3[]=
{
  ...
  {"bit"               ,SQL_BIT           ,8         ,"" ,"" ,"NULL"             ,1,1,SQL_SEARCHABLE,0       ,0,0,"bit"               ,0   ,0  ,0                 ,0,0 ,SQL_BIT          },
  ...
  {"float"             ,SQL_REAL          ,12        ,"" ,"" ,"'precision,scale'",1,0,SQL_SEARCHABLE,0       ,0,1,"float"             ,-38 ,38 ,0                 ,0,10,SQL_REAL         },
...
// TODO: consider adding dattime(6) here
...
MADB_TypeInfo TypeInfoV2[]=
{
    ...
    {"float",SQL_REAL,10,"","","'precision,scale'",1,0,SQL_SEARCHABLE,0,0,1,"float",-38,38,0,0,10, SQL_FLOAT},
