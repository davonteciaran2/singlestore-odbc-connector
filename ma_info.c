...
MADB_TypeInfo TypeInfoV3[]=
{
  ...
  {"bool"              ,SQL_TINYINT       ,1         ,"" ,"" ,"NULL"             ,1,1,SQL_SEARCHABLE,0       ,0,0,"bool"              ,0   ,0  ,0                 ,0,10,SQL_BINARY       },
  {"boolean"           ,SQL_TINYINT       ,1         ,"" ,"" ,"NULL"             ,1,1,SQL_SEARCHABLE,0       ,0,0,"boolean"           ,0   ,0  ,0                 ,0,10,SQL_BINARY       },
  ...
  {"bigint unsigned"   ,SQL_BIGINT        ,20        ,"" ,"" ,"NULL"             ,1,0,SQL_SEARCHABLE,SQL_TRUE,0,1,"bigint unsigned"   ,0   ,0  ,0                 ,0,10,SQL_BIGINT       },
  {"blob"              ,SQL_LONGVARBINARY ,65535     ,"'","'","NULL"             ,1,1,SQL_SEARCHABLE,0       ,0,0,"blob"              ,0   ,0  ,0                 ,0,0 ,SQL_LONGVARBINARY},
  {"long varbinary"    ,SQL_LONGVARBINARY ,2147483647,"'","'","NULL"             ,1,1,SQL_SEARCHABLE,0       ,0,0,"long varbinary"    ,0   ,0  ,0                 ,0,0 ,SQL_LONGVARBINARY},
  ...
  {"int unsigned"      ,SQL_INTEGER       ,10        ,"" ,"" ,"NULL"             ,1,0,SQL_SEARCHABLE,SQL_TRUE,0,1,"int unsigned"      ,0   ,0  ,0                 ,0,10,SQL_INTEGER      },
  {"mediumint"         ,SQL_INTEGER       ,7         ,"" ,"" ,"NULL"             ,1,0,SQL_SEARCHABLE,0       ,0,1,"mediumint"         ,0   ,0  ,0                 ,0,10,SQL_INTEGER      },
  {"mediumint unsigned",SQL_INTEGER       ,8         ,"" ,"" ,"NULL"             ,1,0,SQL_SEARCHABLE,SQL_TRUE,0,1,"mediumint unsigned",0   ,0  ,0                 ,0,10,SQL_INTEGER      },
  ...
  {"float"             ,SQL_FLOAT         ,12        ,"" ,"" ,"'precision,scale'",1,0,SQL_SEARCHABLE,0       ,0,1,"float"             ,-38 ,38 ,0                 ,0,10,SQL_FLOAT        },
  {"double"            ,SQL_DOUBLE        ,22        ,"" ,"" ,"'precision,scale'",1,0,SQL_SEARCHABLE,0       ,0,1,"double"            ,-308,308,0                 ,0,10,SQL_DOUBLE       },
  {"double precision"  ,SQL_DOUBLE        ,22        ,"" ,"" ,"'precision,scale'",1,0,SQL_SEARCHABLE,0       ,0,1,"double precision"  ,-308,308,0                 ,0,10,SQL_DOUBLE       },
  {"real"              ,SQL_DOUBLE        ,22        ,"" ,"" ,"'precision,scale'",1,0,SQL_SEARCHABLE,0       ,0,1,"real"              ,-308,308,0                 ,0,10,SQL_DOUBLE       },
  ...
  {"time"              ,SQL_TYPE_TIME     ,8         ,"'","'","NULL"             ,1,0,SQL_SEARCHABLE,0       ,0,0,"time"              ,0   ,0  ,SQL_CODE_TIME     ,0,0 ,SQL_DATETIME     },
...
MADB_TypeInfo TypeInfoV2[]=
{
  ...
  {"bit"               ,SQL_BINARY       ,8         ,"" ,"" ,"NULL"             ,1,1,SQL_SEARCHABLE,0        ,0,0,"bit"               ,0    ,0  ,0,0,10, SQL_BINARY       },
  {"bool"              ,SQL_TINYINT      ,1         ,"" ,"" ,"NULL"             ,1,1,SQL_SEARCHABLE,0        ,0,0,"bool"              ,0    ,0  ,0,0,10, SQL_BINARY       },
  {"boolean"           ,SQL_TINYINT      ,1         ,"" ,"" ,"NULL"             ,1,1,SQL_SEARCHABLE,0        ,0,0,"boolean"           ,0    ,0  ,0,0,10, SQL_BINARY       },
  ...
  {"datetime"          ,SQL_TIMESTAMP    ,26        ,"'","'","'scale'"          ,1,0,SQL_SEARCHABLE,0        ,0,0,"datetime"          ,0    ,0  ,0,0,10, SQL_DATETIME     },
...
MADB_TypeInfo* GetTypeInfo(SQLSMALLINT SqlType, MYSQL_FIELD *Field)
{
  int i;
